...
<div class="card-header">
  ...
  <img src="img/breeds/{{$cat->breed->id}}.jpg" class="card-img-top" alt="" style="max-height:100px; object-fit:cover;">
  <div class="card-body">
    <ul class="list-group list-group-flush">
        <li class="list-group-item">
            <div class="progress">
                <div class="progress-bar w-{{($cat->current_hp * 100/ $cat->breed->max_hp)}}" role="progressbar" aria-valuenow="{{$cat->current_hp}}" aria-valuemin="0" aria-valuemax="{{$cat->breed->max_hp}}">{{$cat->current_hp}} / {{ $cat->breed->max_hp }}</div>
            </div>
        </li>
